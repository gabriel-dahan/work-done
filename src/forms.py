...
class RegistrationForm(FlaskForm):
    username = StringField(
        ...
        validators = [
            ...
            Regexp(
                '^([a-z0-9]|_)+$', 
                message = 'Le nom d\'utilisateur ne peut que contenir des lettres minuscules, chiffres et underscores.'
            )
        ]
    )
...
class EditProfileForm(FlaskForm):
    username = StringField(
        ...
        validators = [
            ...
            Regexp(
                '^([a-z0-9]|_)+$', 
                message = 'Le nouveau nom d\'utilisateur ne peut que contenir des lettres minuscules, chiffres et underscores.'
            )
        ]
    )
